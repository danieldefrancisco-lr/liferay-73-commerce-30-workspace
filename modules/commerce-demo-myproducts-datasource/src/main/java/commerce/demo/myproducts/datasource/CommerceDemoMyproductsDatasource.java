...
public class CommerceDemoMyproductsDatasource implements CPDataSource {
	...
	private Collection<Long> getCommerceAccountIdOrders(long companyId, long groupId, 
		...
		System.out.println("Commerce Orders for accountId: "+commerceAccountId + " in channelId/groupId: "+groupId+ " in companyId: "+companyId);
		...
		System.out.println("Number of orders from get: "+commerceOrders.size());
		Collection <Long> commerceOrderIds = new ArrayList<Long>();
		if (commerceOrders != null) {
			for (CommerceOrder commerceOrder : commerceOrders) {
				System.out.println(commerceOrder.getCommerceOrderId());
