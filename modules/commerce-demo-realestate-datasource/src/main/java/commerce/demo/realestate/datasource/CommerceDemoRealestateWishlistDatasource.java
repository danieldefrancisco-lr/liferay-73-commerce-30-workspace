package commerce.demo.realestate.datasource;
...
@Component(
	immediate = true,
	property = "commerce.product.data.source.name=" + CommerceDemoRealestateWishlistDatasource.NAME,
	service = CPDataSource.class
)
public class CommerceDemoRealestateWishlistDatasource implements CPDataSource {
	...
	public CPDataSourceResult getResult(
		...
		System.out.println("Searching for the "+CommerceDemoRealestateWishlistDatasourceConstants.MAX_NUMBER_RESULTS+" most frequently wishlisted products");
